...
import { investmentPositionTypeLabels } from '../lib/labels'
import { calculatePortfolioLinkage, calculatePortfolioPositions } from '../lib/portfolio'
import type { InvestmentPositionType } from '../types/planner'
    ...
    <section className="planning-page portfolio-page">
      <section className="section-grid">
        <section className="content-panel">
          <div className="section-heading">
            <div>
              <h2>投资组合驾驶舱</h2>
              <p className="caption">
                持仓明细、真实收益、目标仓位、家庭投资资产和现金流在这里统一联动。
              </p>
            </div>
          </div>

          <div className="summary-grid portfolio-summary-grid">
            <article className="summary-card portfolio-summary-card portfolio-summary-card-primary">
              <strong>持仓总市值</strong>
              <p>来自你手动录入的持仓明细最新价。</p>
              <span className="summary-value">{formatCurrency(positions.totalMarketValue)}</span>
            </article>
            <article className="summary-card portfolio-summary-card portfolio-summary-card-primary">
              <strong>总持仓成本</strong>
              <p>按成本价与数量自动累计。</p>
              <span className="summary-value">{formatCurrency(positions.totalCostAmount)}</span>
            </article>
            <article className="summary-card portfolio-summary-card portfolio-summary-card-primary">
              <strong>真实净收益</strong>
              <p>浮动盈亏叠加分红、扣除手续费后计算。</p>
              <span className="summary-value">{formatCurrency(positions.totalNetProfit)}</span>
            </article>
            <article className="summary-card portfolio-summary-card portfolio-summary-card-primary">
              <strong>真实收益率</strong>
              <p>更接近你实际投资账户回报。</p>
              <span className="summary-value">
                {formatPercent(positions.totalNetReturnRate)}
              </span>
            </article>
        ...
        <aside className="content-panel">
          ...
          <div className="insight-grid portfolio-quick-grid">
      ...
      <section className="content-panel">
        ...
        <div className="toolbar-controls portfolio-toolbar">
          <label className="field">
            <span>按代码搜索</span>
            <input
              value={searchTerm}
        ...
        <div className="form-actions portfolio-actions-row">
          <button
